...
/**
 * Live poll Pie chart result for poll rendering.
 *
...
define(["jquery", "core/log", "mod_livepoll/barchart-result-lazy"],
    function($, Log, BarChartResult) {
        ...
        // Prototype extension.
        DoughnutChartResult.prototype = Object.create(BarChartResult.prototype);

        return (DoughnutChartResult);
    }
);
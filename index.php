...
/**
 * Display information about all the mod_livepoll modules in the requested course.
 *
...
$PAGE->set_url('/mod/livepoll/index.php', array('id' => $id));
...
$modulenameplural = get_string('modulenameplural', 'mod_livepoll');
